      ...
      `}>
        ...
        {isSettingsOpen && (
          <SettingsModal 
              ...
              onImport={importSave} 
              onExport={exportSave}
              onPrestige={prestigeGame} 
              onCheckEvents={checkMissingEvents} 
              currentInfo={gameState.resources[ResourceType.INFO]} 
              currentDejaVu={gameState.resources[ResourceType.DEJAVU]} 
          />
        )}
