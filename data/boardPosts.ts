...
export const BOARD_POSTS: BoardPost[] = [
  ...
  },
  {
    ...
    timestamp: 'NULL',
    image: 'Disc',
    imageDescription: '图片展示了一张纯黑色的图像。图像中没有任何可见的物体或光线。',
    fileSize: 'NaN',
    filename: 'void.iso',
    postNumber: 0,
