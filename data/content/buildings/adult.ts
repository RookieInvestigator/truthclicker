...
export const ADULT_BUILDINGS: Building[] = [
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.FUNDS]: 20, [ResourceType.FOLLOWERS]: 2, [ResourceType.PLEASURE]: 1.0 }, // 25 -> 20
    costMultiplier: 1.35,
    icon: 'Camera',
    unlockRequirement: 0, // Reset
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.FUNDS]: 30, [ResourceType.PLEASURE]: 2.0, [ResourceType.FOLLOWERS]: 5.0, [ResourceType.POWER]: -2.0 }, // Power cost
    costMultiplier: 1.3,
    icon: 'Video',
    unlockRequirement: 0, // Reset
    requireTech: ['rule_34'],
  },
  {
    ...
    baseProduction: { [ResourceType.PLEASURE]: 5.0, [ResourceType.PROBABILITY]: 0.01, [ResourceType.FUNDS]: 8.0, [ResourceType.OPS]: -5.0 }, // Ops cost
    costMultiplier: 1.25,
    icon: 'Gem',
    unlockRequirement: 0, // Reset
    requireTech: ['rule_34'],
  },
  {
    ...
    baseProduction: { [ResourceType.FUNDS]: 80, [ResourceType.BIOMASS]: -2.0, [ResourceType.PLEASURE]: 3.0 }, // 100 -> 80
    costMultiplier: 1.3,
    icon: 'Droplets',
    unlockRequirement: 0, // Reset
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.OPS]: 250.0, [ResourceType.PROBABILITY]: 0.02, [ResourceType.PLEASURE]: -30.0 }, // 300 -> 250
    costMultiplier: 1.4,
    icon: 'Shield',
    unlockRequirement: 0, // Reset
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.FOLLOWERS]: 30, [ResourceType.MIND_CONTROL]: 0.5, [ResourceType.PLEASURE]: 5.0, [ResourceType.OPS]: -5.0 }, 
    costMultiplier: 1.35,
    icon: 'Heart',
    unlockRequirement: 0, // Reset
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.PLEASURE]: 20.0, [ResourceType.POWER]: -50.0 }, // Power cost
    costMultiplier: 1.4,
    icon: 'Zap',
    unlockRequirement: 0, // Reset
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.OPS]: 80.0, [ResourceType.PLEASURE]: -10.0 }, // 100 -> 80
    costMultiplier: 1.4,
    icon: 'Activity',
    unlockRequirement: 0, // Reset
    requireTech: ['hedonistic_imperative'],
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.PLEASURE]: 200.0, [ResourceType.BIOMASS]: -50.0, [ResourceType.REALITY]: -0.0002, [ResourceType.POWER]: -200.0 }, // Added power cost
    costMultiplier: 1.6,
    icon: 'Zap',
    unlockRequirement: 0, // Reset
    requireTech: ['hedonistic_imperative'],
