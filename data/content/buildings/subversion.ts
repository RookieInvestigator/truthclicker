...
export const SUBVERSION_BUILDINGS: Building[] = [
  // --- TIER 1-2 ---
  {
    ...
    baseProduction: { [ResourceType.SPAM]: 2.0, [ResourceType.FOLLOWERS]: 1.0, [ResourceType.TINFOIL]: 0.5, [ResourceType.RED_PILL]: 0.002 }, // Added Red Pill
    costMultiplier: 1.2,
    icon: 'Disc',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.RUMORS]: 2.0, [ResourceType.PANIC]: 0.5, [ResourceType.RED_PILL]: 0.2, [ResourceType.FUNDS]: -20.0, [ResourceType.INFO]: -100.0 }, // Consumes Info & Funds
    costMultiplier: 1.3,
    icon: 'Users',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.RUMORS]: 3.0, [ResourceType.FUNDS]: 40.0, [ResourceType.TINFOIL]: 0.5 }, // Nerfed Funds
    costMultiplier: 1.3,
    icon: 'Smile',
    unlockRequirement: 0, 
    requireTech: ['conspiracy_101'],
  ...
  // --- TIER 3 ---
  {
    ...
    baseProduction: { [ResourceType.TINFOIL]: 1.5, [ResourceType.INFO]: 20.0, [ResourceType.CRED]: -1.0, [ResourceType.POWER]: -5.0 }, // Power cost
    costMultiplier: 1.3,
    icon: 'WifiOff',
    unlockRequirement: 0,
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.RED_PILL]: 0.8, [ResourceType.FOLLOWERS]: 10.0, [ResourceType.FUNDS]: 8.0, [ResourceType.INFO]: -20.0 }, // Consumes Info to make content
    costMultiplier: 1.35,
    icon: 'Mic',
    unlockRequirement: 0,
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.PANIC]: 2.0, [ResourceType.RUMORS]: 5.0, [ResourceType.RED_PILL]: 0.3, [ResourceType.FUNDS]: -60.0 }, // Cost increased
    costMultiplier: 1.35,
    icon: 'Drama',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.STORY]: 2.0, [ResourceType.RUMORS]: 3.0, [ResourceType.RED_PILL]: 0.4, [ResourceType.POWER]: -50.0, [ResourceType.OPS]: -50.0, [ResourceType.INFO]: -200.0 }, // Consumes Info
    costMultiplier: 1.4,
    icon: 'Video',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.FOLLOWERS]: 20, [ResourceType.MIND_CONTROL]: 0.8, [ResourceType.POWER]: -100.0, [ResourceType.CULTURE]: -2.0, [ResourceType.CRED]: -1.0 }, 
    costMultiplier: 1.4,
    icon: 'Radio',
    unlockRequirement: 0, 
  ...
  // --- TIER 4 ---
  {
    ...
    baseProduction: { [ResourceType.TINFOIL]: 2.5, [ResourceType.FOSSIL]: 5.0, [ResourceType.ANCIENT_WISDOM]: 0.2, [ResourceType.KNOWLEDGE]: -1.0 }, 
    costMultiplier: 1.45,
    icon: 'Mountain',
    unlockRequirement: 0,
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.RED_PILL]: 2.0, [ResourceType.FUNDS]: 150.0, [ResourceType.BIOMASS]: 10.0, [ResourceType.PLEASURE]: -5.0 }, 
    costMultiplier: 1.45,
    icon: 'Swords',
    unlockRequirement: 0,
    requireTech: ['cultural_pessimism'],
  },
  {
    ...
    baseProduction: { [ResourceType.TECH_CAPITAL]: 0.2, [ResourceType.PANIC]: 1.0, [ResourceType.FUNDS]: -20.0, [ResourceType.INFO]: -50.0 }, 
    costMultiplier: 1.35,
    icon: 'Gamepad2',
    unlockRequirement: 0,
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.MIND_CONTROL]: 1.0, [ResourceType.SPAM]: -10.0, [ResourceType.RED_PILL]: 0.1, [ResourceType.OPS]: -50.0, [ResourceType.INFO]: -200.0 }, // Consumes Info
    costMultiplier: 1.35,
    icon: 'EyeOff',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.PANIC]: 5.0, [ResourceType.RUMORS]: 10.0, [ResourceType.RED_PILL]: 1.0, [ResourceType.CRED]: -10.0, [ResourceType.FUNDS]: -100.0 }, 
    costMultiplier: 1.5,
    icon: 'Flag',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.FUNDS]: 150, [ResourceType.MIND_CONTROL]: 1.0, [ResourceType.OPS]: -20.0, [ResourceType.INFO]: -100.0 }, 
    costMultiplier: 1.4,
    icon: 'Monitor',
    unlockRequirement: 0, 
    requireTech: ['neurolinguistic_programming'],
  },
  {
    ...
    category: BuildingCategory.SUBVERSION,
    baseCosts: { [ResourceType.FUNDS]: 20000, [ResourceType.OPS]: 5000 },
    baseProduction: { [ResourceType.TINFOIL]: 1.0, [ResourceType.FUNDS]: -400, [ResourceType.MIND_CONTROL]: 1.5, [ResourceType.RUMORS]: 3.0 }, 
    costMultiplier: 1.4,
    icon: 'CloudRain',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.PANIC]: 2.0, [ResourceType.LORE]: 5.0, [ResourceType.TINFOIL]: 0.5, [ResourceType.REALITY]: -0.0001, [ResourceType.INFO]: -500.0 }, // Reality leak & Info cost
    costMultiplier: 1.5,
    icon: 'Shuffle',
    unlockRequirement: 0, 
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.MIND_CONTROL]: 3.0, [ResourceType.BIOMASS]: -10.0, [ResourceType.TINFOIL]: 0.8, [ResourceType.FUNDS]: -150.0 }, 
    costMultiplier: 1.45,
    icon: 'Droplets',
    unlockRequirement: 0, 
  ...
  // --- TIER 5 ---
  {
    ...
    baseProduction: { [ResourceType.RED_PILL]: 5.0, [ResourceType.BIOMASS]: 50.0, [ResourceType.FOLLOWERS]: 20.0, [ResourceType.INFO]: -500.0 }, // Information isolation
    costMultiplier: 1.5,
    icon: 'Home',
    unlockRequirement: 0,
  ...
  },
  {
    ...
    baseProduction: { [ResourceType.TINFOIL]: 8.0, [ResourceType.ANCIENT_WISDOM]: 2.0, [ResourceType.FOSSIL]: -5.0, [ResourceType.POWER]: -200.0 }, 
    costMultiplier: 1.6,
    icon: 'Circle', // Hole
    unlockRequirement: 0,
    requireTech: ['hyperborean_myth'],
